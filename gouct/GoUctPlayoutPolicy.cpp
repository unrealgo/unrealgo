...
const char *GoUctPlayoutPolicyTypeStr(GoUctPlayoutPolicyType type) {
  ...
  switch (type) {
    case GOUCT_FILLBOARD:return "Fillboard";
    case GOUCT_NAKADE:return "Nakade";
    case GOUCT_ATARI_CAPTURE:return "AtariCapture";
    case GOUCT_ATARI_DEFEND:return "AtariDefend";
    case GOUCT_LOWLIB:return "LowLib";
    case GOUCT_PATTERN:return "Pattern";
    case GOUCT_GAMMA_PATTERN:return "GammaPattern";
    case GOUCT_REPLACE_CAPTURE:return "ReplaceCapture";
    case GOUCT_CAPTURE:return "Capture";
    case GOUCT_RANDOM:return "Random";
    case GOUCT_SELFATARI_CORRECTION:return "SelfAtariCorr";
    case GOUCT_CLUMP_CORRECTION:return "ClumpCorr";
    case GOUCT_PASS:return "Pass";
    default:return "?";
  }
}
...
void GoUctPlayoutPolicyStat::Write(std::ostream &out) const {
  ...
  for (int i = 0; i < _GOUCT_NU_DEFAULT_PLAYOUT_TYPE; ++i) {
    auto type = static_cast<GoUctPlayoutPolicyType>(i);
