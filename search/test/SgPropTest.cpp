...
void SgPropMoveTest_ToString_Go(GoPoint p, int boardSize, int fileFormat,
...
BOOST_AUTO_TEST_CASE(SgPropMoveTest_ToString_GoAll) {
  if (GO_MAX_SIZE >= 19) {
    ...
    SgPropMoveTest_ToString_Go(GO_PASS, 19, 3, "tt");
    SgPropMoveTest_ToString_Go(GO_PASS, 9, 3, "tt");
    SgPropMoveTest_ToString_Go(GO_PASS, 19, 4, "");
  }
}

void SgPropMoveTest_ToString_Hex(GoPoint p, int boardSize,
                                 const char *targetValue) {
  vector<string> values;
  SgPropMove prop(SG_PROP_MOVE, p);
  int fileFormat = 4;
...
BOOST_AUTO_TEST_CASE(SgPropMoveTest_FromString_GoAll) {
  if (GO_MAX_SIZE >= 19) {
    ...
    SgPropMoveTest_FromString_Go("tt", 19, GO_PASS);
    SgPropMoveTest_FromString_Go("", 19, GO_PASS);
  }
  ...
  SgPropMoveTest_FromString_Go("tt", 9, GO_PASS);
  SgPropMoveTest_FromString_Go("", 9, GO_PASS);
}
...
BOOST_AUTO_TEST_CASE(SgPropTextListTest) {
  ...
  SgVector<GoPoint> pv = list.GetPointsWithText();
