...
void Test() {
  ...
  std::cout << "original Nodes:" << graphDef.node_size() << std::endl;
  DlGraphUtil::PruneNodesReachableFrom(graphDef, "input_producer/Const");
  std::cout << "pruned Nodes:" << graphDef.node_size() << std::endl;

  DlGraphUtil::WriteToFile(graphDef, "pruned_reachable_from.graph.txt");
}
